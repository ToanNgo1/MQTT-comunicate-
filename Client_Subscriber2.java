...
public class Client_Subscriber2 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String clientId     = "SubscriberClient2";
        ...
        try {
            ...
            sampleClient.setCallback(new MqttCallback() {
                ...
                public void messageSend(String topic, String message) throws InterruptedException
                {
                  try{    
                    ...
                    message_send.setQos(1);
                    sampleClient.publish("DS341/ResultsFrom/Ngo/B", message_send);
            ...
            sampleClient.subscribe("/DS341/TaskTo/Ngo/<B>", 1);    //subscribe to certain topic using QoS 1
